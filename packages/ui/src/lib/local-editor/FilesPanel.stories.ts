...
const secondVaultTree: LocalTreeNode[] = [
  {
    ...
    path: 'daily',
    name: 'daily',
    metadata: { color: 'lavender' },
    children: [{ kind: 'file', path: 'daily/2026-06-18.md', name: '2026-06-18.md' }]
  },
  { kind: 'file', path: 'index.md', name: 'index.md' }
];

const vaultGroups: VaultGroupData[] = [
  { id: VAULT_ID, name: 'demo-vault', accent: 'slate', tree: localEditorTreeFixture },
  { id: SECOND_VAULT_ID, name: 'field-notes', accent: 'teal', tree: secondVaultTree }
];
